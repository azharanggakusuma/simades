          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Data Report</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Manage Menu</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Manage Form</span>
              </a>
            </li>
            <li>
              <a
